    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white shadow-sm mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div>
            <span className="inline-block bg-black text-white text-sm font-medium px-4 py-1.5 rounded-full mb-4">
              Completed Projects
            </span>
            ...
            <p className="text-gray-600 text-lg">
              Explore our complete portfolio of {projects.length} successfully completed real estate projects
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        {projects.length > 0 ? (
          ...
          <div className="text-center py-20">
            ...
            <p className="text-gray-600 mb-6">There are no completed projects to display at the moment.</p>
            <Link
              to="/"

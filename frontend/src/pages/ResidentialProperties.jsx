...
import { Home, MapPin, Bed, Bath, Square, Filter, X } from 'lucide-react'
...
const ResidentialProperties = () => {
  ...
  const residentialTypes = ['Apartment', 'Villa', 'House', 'Penthouse', 'Plot']
        ...
        {filteredProperties.length > 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-3">
              No {activeTab.toLowerCase()} properties found
            </h3>
            <p className="text-gray-600 mb-6 max-w-md mx-auto">
              We couldn't find any residential properties matching your criteria. Try adjusting your filters or check back later.
            </p>
            <button 
              onClick={clearFilters}

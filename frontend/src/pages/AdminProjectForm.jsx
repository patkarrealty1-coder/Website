    ...
    <div className="min-h-screen bg-gray-100">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center gap-4 mb-6">
          <Link to="/management/projects" className="text-gray-600 hover:text-gray-900">
            <ArrowLeft className="h-6 w-6" />
          </Link>
          <h1 className="text-3xl font-bold text-gray-900">
            {isEdit ? 'Edit Completed Project' : 'Add New Completed Project'}
          </h1>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow p-6 space-y-6">
          ...
          <div className="flex gap-4">
            <button
              type="submit"
              disabled={loading}
              className="flex-1 px-6 py-3 bg-green-800 text-white rounded-lg hover:bg-green-900 disabled:bg-gray-400"
            >
